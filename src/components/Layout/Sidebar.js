...
import sidebarBgImage from 'assets/img/sidebar/sidebar-x.jpg';
...
const navItems = [
  ...
  { to: '/forms', name: 'Add Defect', exact: false, Icon: MdStar },
  { to: '/tables', name: 'View Defects', exact: false, Icon: MdBorderAll },
];
